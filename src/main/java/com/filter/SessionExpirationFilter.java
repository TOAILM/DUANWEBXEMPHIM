...
//            httpResponse.sendRedirect(httpRequest.getContextPath() + "/Nhom6_ASM1/views/login.jsp");
...
//        int maxInactiveInterval = 30; // Thiết lập thời gian hết hạn của session là 30 giây
